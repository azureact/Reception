...
driver.get("")
driver.find_element(By.XPATH,"//*[@id='html-body']/div[2]/div[2]/div/div[1]/div[1]/form/div[1]/div/input").send_keys("") #登录页面
driver.find_element(By.XPATH,"//*[@id='html-body']/div[2]/div[2]/div/div[1]/div[1]/form/div[2]/div/input").send_keys("") #被自动填写的Wikidot账号
driver.find_element(By.XPATH,"//*[@id='html-body']/div[2]/div[2]/div/div[1]/div[1]/form/div[4]/div/button").click() #被自动填写的Wikidot密码
...
def verify(ctx, wikidot_id: str):
    ...
    try:
        ...
        driver.find_element(By.XPATH, '//*[@id="pm-subject"]').send_keys('xxxDiscord服务器验证码') #wikidot网站名称
